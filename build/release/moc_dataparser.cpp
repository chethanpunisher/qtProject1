...
void DataParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->calParsed((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        ...
        {
            using _t = void (DataParser::*)(double );
            if (_t _q_method = &DataParser::calParsed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void DataParser::calParsed(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
